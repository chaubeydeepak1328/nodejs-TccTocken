    ...
    try {
        ...
        if (result.status === "1") {
            ...
            contractTxs.forEach(tx => {
                ...
                row.innerHTML = `
                  <td class="p-3.5 text-sm text-white dark:text-gray-400">
                  ...
                  <td class="p-3.5 text-sm text-white dark:text-gray-400">${ethValue} ETH</td>
                  <td class="p-3.5 text-sm text-white dark:text-gray-400">${tx.from}</td>
                  <td class="p-3.5 text-sm text-white dark:text-gray-400">${tx.to}</td>
